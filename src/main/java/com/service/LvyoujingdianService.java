...
public interface LvyoujingdianService extends IService<LvyoujingdianEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<LvyoujingdianEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<LvyoujingdianEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<LvyoujingdianEntity> wrapper);
